...
public class LoopStatementHandlerTests extends ESTestCase  {
    ...
    public void testSimpleForLoop() throws InterruptedException {
        ...
        executor.visitProcedureAsync(blockContext, new ActionListener<Object>() {
            ...
            public void onResponse(Object unused) {
                ...
                assertEquals(4.0, context.getVariable("j"));  // After incrementing 3 times (1, 2, 3 -> j = i + 1)
                latch.countDown();
            }
    ...
    public void testSimpleWhileLoop() throws InterruptedException {
        ...
        executor.visitProcedureAsync(blockContext, new ActionListener<Object>() {
            ...
            public void onResponse(Object unused) {
                ...
                assertEquals(4.0, context.getVariable("i"));  // Increment until i < 4 becomes false
                latch.countDown();
            }
    ...
    public void testReverseForLoop() throws InterruptedException {
        ...
        executor.visitProcedureAsync(blockContext, new ActionListener<Object>() {
            ...
            public void onResponse(Object unused) {
                ...
                assertNotNull("j should be declared.", context.getVariable("j"));
                assertEquals(5.0 + 4.0 + 3.0, context.getVariable("j"));  // Sum of 5, 4, and 3
                latch.countDown();
            }
    ...
    public void testWhileLoopFalseInitialCondition() throws InterruptedException {
        String blockQuery = "BEGIN DECLARE i NUMBER = 5; WHILE i < 4 LOOP SET i = i + 1; END LOOP END";
        PlEsqlProcedureParser.ProcedureContext blockContext = parseBlock(blockQuery);
        ...
        executor.visitProcedureAsync(blockContext, new ActionListener<Object>() {
            ...
            public void onResponse(Object unused) {
                ...
                assertNotNull("i should be declared.", context.getVariable("i"));
                assertEquals(5.0, context.getVariable("i"));  // No loop iteration
                latch.countDown();
            }
    ...
    public void testNestedForLoop() throws InterruptedException {
        String blockQuery = "BEGIN DECLARE i NUMBER; DECLARE j NUMBER; FOR i IN 1..2 LOOP FOR j " +
        ...
        executor.visitProcedureAsync(blockContext, new ActionListener<Object>() {
            ...
            public void onResponse(Object unused) {
                ...
                assertNotNull("i should be declared.", context.getVariable("i"));
                assertNotNull("j should be declared.", context.getVariable("j"));
                assertEquals(2.0, context.getVariable("i"));  // 'i' will be 2 after the loop
                assertEquals(3.0, context.getVariable("j"));  // 'j' will be 3 after the loop (incremented twice in inner loop)
                latch.countDown();
            }
    ...
    public void testInfiniteWhileLoop() throws InterruptedException {
        ...
        executor.visitProcedureAsync(blockContext, new ActionListener<Object>() {
            ...
            public void onResponse(Object unused) {
                ...
                assertNotNull("i should be declared.", context.getVariable("i"));
                assertEquals(1001.0, context.getVariable("i"));
                latch.countDown();
            }
