...
public class PlEsqlProcedureLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"END", "BEGIN", "EXECUTE", "DECLARE", "SET", "FOR", "IN", "OUT", "INOUT", 
			...
			"GREATER_EQUAL", "LESS_EQUAL", "OR", "AND", "EQUAL", "DOT_DOT", "PIPE", 
			"DOT", "LPAREN", "RPAREN", "COMMA", "COLON", "SEMICOLON", "FLOAT", "INT", 
			...
			"DOCUMENT_REMOVE", "DOCUMENT_CONTAINS"
		};
	}
