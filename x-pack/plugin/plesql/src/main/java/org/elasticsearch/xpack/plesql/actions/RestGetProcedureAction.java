...
public class RestGetProcedureAction extends BaseRestHandler {
    ...
    public RestGetProcedureAction(PlEsqlExecutor plEsqlExecutor) {
    ...
    public List<Route> routes() {
        return List.of(
            Route.builder(RestRequest.Method.GET, "/_query/plesql/procedure/{procedure_id}").build()
        );
    }
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) {
        ...
        return channel -> plEsqlExecutor.getProcedureAsync(id, new ActionListener<>() {
            @Override
