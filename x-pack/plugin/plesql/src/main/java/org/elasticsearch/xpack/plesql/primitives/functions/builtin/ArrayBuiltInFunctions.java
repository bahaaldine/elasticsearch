...
public class ArrayBuiltInFunctions {
    ...
    public static void registerAll(ExecutionContext context) {
        ...
        context.declareFunction("ARRAY_LENGTH", new BuiltInFunctionDefinition("ARRAY_LENGTH", (BuiltInFunction) (List<Object> args) -> {
            if (args.size() != 1) {
        ...
        context.declareFunction("ARRAY_APPEND", new BuiltInFunctionDefinition("ARRAY_APPEND", (BuiltInFunction) (List<Object> args) -> {
            if (args.size() != 2) {
        ...
        context.declareFunction("ARRAY_PREPEND", new BuiltInFunctionDefinition("ARRAY_PREPEND", (BuiltInFunction) (List<Object> args) -> {
            if (args.size() != 2) {
        ...
        context.declareFunction("ARRAY_REMOVE", new BuiltInFunctionDefinition("ARRAY_REMOVE", (BuiltInFunction) (List<Object> args) -> {
            if (args.size() != 2) {
        ...
        context.declareFunction("ARRAY_CONTAINS", new BuiltInFunctionDefinition("ARRAY_CONTAINS", (BuiltInFunction) (List<Object> args) -> {
            if (args.size() != 2) {
        ...
        context.declareFunction("ARRAY_DISTINCT", new BuiltInFunctionDefinition("ARRAY_DISTINCT", (BuiltInFunction) (List<Object> args) -> {
            if (args.size() != 1) {
