...
public class RestCreateProcedureAction extends BaseRestHandler {
    ...
    public RestCreateProcedureAction(PlEsqlExecutor plEsqlExecutor) {
    ...
    public List<Route> routes() {
        return List.of(
            Route.builder(RestRequest.Method.PUT, "/_query/plesql/procedure/{procedure_id}").build()
        );
    }
    ...
    protected RestChannelConsumer prepareRequest(RestRequest request, NodeClient client) throws IOException {
        ...
        return channel -> plEsqlExecutor.storeProcedureAsync(id, procedure, new ActionListener<>() {
            @Override
