...
/**
 * Handles string lexicographic less-than {@literal <}.
 */
public class StringLessThanOperatorHandler implements BinaryOperatorHandler {

    @Override
    public boolean isApplicable(Object left, Object right) {
        // Only applicable if both operands are strings
