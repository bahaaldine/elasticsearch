...
public class PlEsqlProcedureParser extends Parser {
	...
	public static final int
		...
		FLOAT_TYPE=24, STRING_TYPE=25, DATE_TYPE=26, NUMBER_TYPE=27, ARRAY_TYPE=28,
		PLUS=29, MINUS=30, MULTIPLY=31, DIVIDE=32, GREATER_THAN=33, LESS_THAN=34,
		NOT_EQUAL=35, GREATER_EQUAL=36, LESS_EQUAL=37, OR=38, AND=39, EQUAL=40,
		DOT_DOT=41, PIPE=42, DOT=43, LPAREN=44, RPAREN=45, COMMA=46, COLON=47,
		SEMICOLON=48, FLOAT=49, INT=50, STRING=51, ID=52, COMMENT=53, WS=54;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"STRING_TYPE", "DATE_TYPE", "NUMBER_TYPE", "ARRAY_TYPE", "PLUS", "MINUS",
	...
	public final ProcedureContext procedure() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 8743317545457544L) != 0) );
			setState(74);
			match(END);
			setState(75);
			match(EOF);
	...
	public final Function_callContext function_call() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8461842561105920L) != 0)) {
				{
				setState(252);
				argument_list();
				}
	...
	public final RelationalExpressionContext relationalExpression() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 231928233984L) != 0)) {
				{
				{
				setState(303);
				_la = _input.LA(1);
