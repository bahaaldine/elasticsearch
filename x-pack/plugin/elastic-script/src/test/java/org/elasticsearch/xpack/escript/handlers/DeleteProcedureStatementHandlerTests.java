...
public class DeleteProcedureStatementHandlerTests extends ESIntegTestCase {
    ...
    public void testDeleteStoredProcedure() throws Exception {
        ...
        elasticScriptExecutor.storeProcedureAsync("deleteMe", procedureText, ActionListener.wrap(
        ...
        elasticScriptExecutor.executeProcedure(deleteStmt, Map.of(), ActionListener.wrap(
            success -> {
