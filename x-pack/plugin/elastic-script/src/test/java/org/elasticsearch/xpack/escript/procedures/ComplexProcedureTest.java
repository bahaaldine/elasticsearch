...
package org.elasticsearch.xpack.escript.procedures;
...
public class ComplexProcedureTest extends ESTestCase {
    ...
    public void setUp() throws Exception {
        ...
        ElasticScriptLexer dummyLexer = new ElasticScriptLexer(CharStreams.fromString(""));
    ...
    public void testComplexProcedureAllPositives() throws InterruptedException {
        ...
        ElasticScriptParser.ProcedureContext procCtx = TestUtils.parseBlock(proc);
