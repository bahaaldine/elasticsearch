...
public class FunctionDefinitionHandlerTests extends ESTestCase {
    ...
    private ElasticScriptParser.Function_definitionContext parseFunction(String query) {
    ...
    public void testFunctionDefinitionWithoutParameters() throws InterruptedException {
        ...
        ElasticScriptParser.Function_definitionContext funcCtx = parseFunction(functionQuery);
    ...
    public void testFunctionDefinitionAndCallWithinBlock() throws InterruptedException {
        String blockQuery = """
            ...
            END PROCEDURE
        """;
        ElasticScriptParser.ProcedureContext blockCtx = parseBlock(blockQuery);
        CountDownLatch latch = new CountDownLatch(1);
