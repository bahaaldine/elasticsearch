...
public class AssignmentStatementHandlerTests extends ESTestCase {
    ...
    private ElasticScriptParser.Assignment_statementContext parseAssignment(String query) {
    ...
    public void testArrayAssignmentTypeMismatch() {
        ...
        try {
            ...
            ElasticScriptParser.Assignment_statementContext assignCtx = parseAssignment(assignQuery);
