...
package org.elasticsearch.xpack.escript.visitors;
 ...
 */
public class ProcedureDefinitionVisitor extends ElasticScriptBaseVisitor<Object> {
    ...
    @Override
    public Object visitProcedure(ElasticScriptParser.ProcedureContext ctx) {
        ...
        if (ctx.parameter_list() != null) {
            for (ElasticScriptParser.ParameterContext pCtx : ctx.parameter_list().parameter()) {
        ...
        List<ElasticScriptParser.StatementContext> body = ctx.statement();
