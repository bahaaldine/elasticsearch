...
/**
 * The FunctionDefinition class represents a user-defined function within the Elastic Script execution context.
...
public abstract class FunctionDefinition {
    ...
    private final List<ElasticScriptParser.StatementContext> body;
     ...
     */
    public FunctionDefinition(String name, List<Parameter> parameters, List<ElasticScriptParser.StatementContext> body) {
        this.name = name;
     ...
     */
    public List<ElasticScriptParser.StatementContext> getBody() {
        return body;
    }
