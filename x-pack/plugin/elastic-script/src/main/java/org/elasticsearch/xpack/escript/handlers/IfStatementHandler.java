...
public class IfStatementHandler {
     ...
     */
    public void handleAsync(ElasticScriptParser.If_statementContext ctx, ActionListener<Object> listener) {
        ActionListener<Object> ifStatementListener = new ActionListener<Object>() {
            ...
            public void onResponse(Object conditionResult) {
                if ( conditionResult instanceof Boolean && (Boolean) conditionResult ) {
                    ...
                    List<ElasticScriptParser.StatementContext> thenStatements = ctx.then_block;
     ...
     * @param listener The ActionListener to handle asynchronous callbacks.
     */
    private void handleElseIfBlocksAsync(ElasticScriptParser.If_statementContext ctx, int index, ActionListener<Object> listener) {
        List<ElasticScriptParser.Elseif_blockContext> elseifBlocks = ctx.elseif_block();
        ...
        if (index >= elseifBlocks.size()) {
            ...
            if ( ctx.else_block != null && ctx.else_block.isEmpty() == false ) {
                ...
                List<ElasticScriptParser.StatementContext> elseStatements = ctx.else_block;
        ...
        ElasticScriptParser.Elseif_blockContext elseifBlock = elseifBlocks.get(index);
        ...
        ActionListener<Object> elseIfStatementListener = new ActionListener<Object>() {
            ...
            public void onResponse(Object elseifResult) {
                if ( elseifResult instanceof Boolean && (Boolean) elseifResult ) {
                    ...
                    List<ElasticScriptParser.StatementContext> elseifStatements = elseifBlock.statement();
